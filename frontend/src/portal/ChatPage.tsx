...
import { X, Users, Search, Send, Plus, MessageSquare, Phone, Video, Mic, MicOff, Camera, CameraOff, MonitorUp, Loader2, Maximize2 } from 'lucide-react';
import { LiveKitRoom, GridLayout, ParticipantTile, useTracks, useLocalParticipant, FocusLayout, RoomAudioRenderer } from '@livekit/components-react';
...
function ChatControlBar({ initialVideo, onToggleChat, isChatOpen }: { initialVideo: boolean, onToggleChat: () => void, isChatOpen: boolean }) {
  ...
  return (
    <div className="flex items-center justify-center gap-4">
      ...
      <button 
        onClick={togglePiP}
        className="p-3 rounded-full flex items-center justify-center transition-colors bg-white/10 hover:bg-white/20 text-white"
